        ...
        <div class="row section-content">
            <div class="col-xs-12 col-md-8">
                <div class="row">
                    ...
                    $Read->ExeRead(DB_POSTS, "WHERE post_status = 1 AND post_private = 1 AND post_date <= NOW() AND (post_category = :ct OR FIND_IN_SET(:ct, post_category_parent)) ORDER BY post_date DESC LIMIT :limit OFFSET :offset", "limit={$Pager->getLimit()}&offset={$Pager->getOffset()}&ct={$category_id}");
                    if (!$Read->getResult()):
                        $Pager->ReturnPage();
