        ...
        case 'license':
            ...
            if (in_array('', $PostData)):
                ...
                try {
                    ...
                    $jSON['trigger'] = AjaxErro("<b class='icon-warning'>ERRO:</b> Desculpe mas não foi possível comunicar com download.workcontrol.com.br.<p>Favor tente mais tarde!</p>", E_USER_ERROR);
                }
