                ...
                <ul class="dashboard_nav_menu">
                    ...
                    if (APP_EAD):
                        ...
                        <?php if ($Admin['user_level'] >= LEVEL_WC_EAD_COURSES): ?>
                            <li class="dashboard_nav_menu_li <?= strstr($getViewInput, 'teach/courses') ? 'dashboard_nav_menu_active' : ''; ?>"><a class="icon-books" title="Cursos" href="dashboard.php?wc=teach/courses">Cursos<?= $wc_ead_courses_alerts; ?></a>
                                <ul class="dashboard_nav_menu_sub">
                                    ...
                                    <li class="dashboard_nav_menu_sub_li <?= $getViewInput == 'teach/coupons' ? 'dashboard_nav_menu_active' : ''; ?>"><a title="Cadastrar Novo Cupom" href="dashboard.php?wc=teach/coupons">&raquo; Cupons</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        <?php
                        if (APP_COMMENTS && $_SESSION['userLogin']['user_level'] >= LEVEL_WC_COMMENTS):
                            ...
                            ?>
                            <li class="dashboard_nav_menu_li <?= strstr($getViewInput, 'comments/') ? 'dashboard_nav_menu_active' : ''; ?>"><a class="icon-bubbles2" title="Avaliações" href="dashboard.php?wc=comments/home">Avaliações<?= $wc_comment_alerts; ?></a></li>
                            <?php
                        endif;
                        ?>
