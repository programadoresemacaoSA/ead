...
<div class="dashboard_content dashboard_users">
    <div class="box box70">
            ...
            <div class="panel">
                <form class="auto_save" class="j_tab_home tab_create" name="user_manager" action="" method="post" enctype="multipart/form-data">
                    ...
                    <label class="label">
                        ...
                        <input value="<?= $user_occupation; ?>" type="text" name="user_occupation" placeholder="Profissão:" required />
                    </label>
                    ...
                    <?php endif; ?>
                    <label class="label">
                        <span class="legend">Biografia</span>
                        <textarea name="user_desc" class="work_mce_basic"><?= $user_desc; ?></textarea>
                    </label>
                    <div class="clear"></div>
        ...
        <article class="box box100 wc_tab_target" id="social" style="padding: 0; margin: 0; display: none;">
            <div class="panel_header default">
                <h2>Redes Sociais </h2>
            </div>
            <div class="panel">
                <form class="auto_save" class="j_tab_home tab_create" name="user_manager" action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="callback" value="Users"/>
                    <input type="hidden" name="callback_action" value="manager_social"/>
                    <input type="hidden" name="user_id" value="<?= $UserId; ?>"/>
                    
                    <label class="label">
                        <span class="legend icon-facebook">Facebook:</span>
                        <input value="<?= $user_facebook; ?>" type="text" name="user_facebook" placeholder="username" />
                    </label>
                    
                    <label class="label">
                        <span class="legend icon-instagram">Instagram:</span>
                        <input value="<?= $user_instagram; ?>" type="text" name="user_instagram" placeholder="@username" />
                    </label>
                    
                    <label class="label">
                        <span class="legend icon-twitter">Twitter:</span>
                        <input value="<?= $user_twitter; ?>" type="text" name="user_twitter" placeholder="@username" />
                    </label>
                    
                    <label class="label">
                        <span class="legend icon-youtube">Youtube:</span>
                        <input value="<?= $user_youtube; ?>" type="text" name="user_youtube" placeholder="http:// link completo" />
                    </label>
                    ...
                    <img class="form_load none fl_right" style="margin-left: 10px; margin-top: 2px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.gif"/>
                    <button name="public" value="1" class="btn btn_green fl_right icon-share" style="margin-left: 5px;">Atualizar Redes Sociais!</button>
                    <div class="clear"></div>
                </form>
                <div class="clear"></div>
            </div>
    ...
    <div class="box box30">
        ...
        <div class="panel">
            <div class="box_conf_menu">
                ...
                <?php endif; ?>
                <a class='conf_menu wc_tab' href='#social'>Redes Sociais</a>
