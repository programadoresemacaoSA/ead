...
if ($CouponId):
    $Read->ExeRead(DB_EAD_COUPONS, "WHERE cp_id = :id", "id={$CouponId}");
    if ($Read->getResult()):
        ...
        header('Location: dashboard.php?wc=teach/coupons');
        exit;
    endif;
else:
    $CarCreate = ['cp_start' => date("Y-m-d H:i:s"), 'cp_end' => date("Y-m-d H:i:s", strtotime("+30day"))];
    $Create->ExeCreate(DB_EAD_COUPONS, $CarCreate);
    header('Location: dashboard.php?wc=teach/coupon&id=' . $Create->getResult());
    exit;
endif;
?>
...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        ...
        <p class="dashboard_header_breadcrumbs">
            ...
            <span class="crumb">/</span>
            <a title="<?= ADMIN_NAME; ?>" href="dashboard.php?wc=teach/coupons">Cupons</a>
            <span class="crumb">/</span>
            Gerenciar Desconto
        </p>
    </div>
    ...
    <div class="dashboard_header_search">
        <a title="Ver Cupons!" href="dashboard.php?wc=teach/coupons" class="btn btn_blue icon-eye">Cupons de Desconto!</a>
    </div>
