...
if (DB_AUTO_TRASH):
    $Delete = new Delete;
    $Delete->ExeDelete(DB_EAD_COUPONS, "WHERE cp_coupon IS NULL AND cp_id >= :st", "st=1");
endif;
?>
...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        ...
        <p class="dashboard_header_breadcrumbs">
            ...
            <span class="crumb">/</span>
            <a title="<?= ADMIN_NAME; ?>" href="dashboard.php?wc=teach/home">Produtos</a>
            <span class="crumb">/</span>
            Cupons de Desconto
        </p>
    </div>
    ...
    <div class="dashboard_header_search">
        <a title="Novo Desconto" href="dashboard.php?wc=teach/coupon" class="btn btn_green icon-plus">Adicionar Cupom!</a>
    </div>
</header>
...
<div class="dashboard_content">
    ...
    $Pager = new Pager("dashboard.php?wc=teach/coupons&page=", "<<", ">>", 3);
    $Pager->ExePager($Page, 12);
    $Read->ExeRead(DB_EAD_COUPONS, "ORDER BY cp_end DESC LIMIT :limit OFFSET :offset", "limit={$Pager->getLimit()}&offset={$Pager->getOffset()}");
    if (!$Read->getResult()):
        $Pager->ReturnPage();
        ...
        foreach ($Read->getResult() as $Coupon):
            ...
            <div class='box_content'>
                ...
                <a title='Editar Cupom!' href='dashboard.php?wc=teach/coupon&id={$Coupon['cp_id']}' class='btn btn_blue icon-pencil icon-notext'></a>
                <span rel='product_coupon' class='j_delete_action btn btn_red icon-cancel-circle icon-notext' id='{$Coupon['cp_id']}'></span>
                <span rel='product_coupon' callback='Courses' callback_action='coupon_remove' class='j_delete_action_confirm btn btn_yellow icon-warning' style='display: none;' id='{$Coupon['cp_id']}'>Deletar Cupom?</span>
            </div>
        </article>";
        endforeach;
        $Pager->ExePaginator(DB_EAD_COUPONS);
