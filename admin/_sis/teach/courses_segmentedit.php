        ...
        <div class="box box100">
            <div class="box_content">
                ...
                <div class="label_50">
                    ...
                    <label class="label">
                        <span class="legend icon-droplet">Cor Predominante:</span>
                        <input style="font-size: 1.5em;" type="text" name="segment_color" value="<?= $segment_color; ?>" placeholder="Cor Predominante do Segmento:" required/>
                    </label>
                </div>
