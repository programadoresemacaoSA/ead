    ...
    <div class="box box100">
        ...
        <div class="panel">
            <form name="class_add" action="" method="post" enctype="multipart/form-data">
                ...
                <label class="label">
                   <label class="label_check label_publish <?= ($class_free == 1 ? 'active' : ''); ?>"><input style="margin-top: -1px;" type="checkbox" value="1" name="class_free" <?= ($class_free == 1 ? 'checked' : ''); ?>> Aula Grátis!</label>
                </label>
