        ...
        foreach ($Read->getResult() as $Segment):
            ...
            <article class="course_segment box box100 wc_draganddrop" callback="Courses" callback_action="segment_order" id="<?= $Segment['segment_id']; ?>">
                <div class='box_content'>
                    <h1 style="color: <?= $Segment['segment_color']; ?>" class="<?= $Segment['segment_icon']; ?>"><b><?= $Segment['segment_title']; ?> <a title='Ver Cursos' href='dashboard.php?wc=teach/courses&segment=<?= $Segment['segment_id']; ?>'><?= $TotalCoursesBySegment; ?> cursos aqui!</a></b></h1>
