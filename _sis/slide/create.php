    ...
    <form name="post_create" action="" method="post" enctype="multipart/form-data">
        ...
        <article class="box box100">
            <div class="panel">
                ...
                <label class="label">
                    <span class="legend">Título do Link</span>
                    <input style="font-size: 1.2em;" type="text" name="slide_link_name" value="<?= $slide_link_name; ?>" required/>
                </label>

                <div class="label_50">
                    <label class="label">
                        <span class="legend">A partir de:</span>
                        <input style="font-size: 1.2em;" type="text" class="jwc_datepicker" name="slide_start" value="<?= (!empty($slide_start) ? date('d/m/Y H:i:s', strtotime($slide_start)) : date('d/m/Y H:i:s')); ?>" required/>
                    </label>

                    <label class="label">
                        <span class="legend">Até dia: (opcional)</span>
                        <input style="font-size: 1.2em;" type="text" class="jwc_datepicker" name="slide_end" value="<?= (!empty($slide_end) ? date('d/m/Y H:i:s', strtotime($slide_end)) : date('d/m/Y H:i:s', strtotime("+1month"))); ?>"/>
                    </label>
                </div>
