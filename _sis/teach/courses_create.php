    ...
    <div class="box box70">
        <div class="panel wc_tab_target wc_active" id="course">
            <form class="auto_save" name="course_create" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="label_50">
                    <label class="label">
                        <span class="legend icon-play">Vídeo divulgação:</span>
                        <input name="course_video" value="<?= $course_video; ?>" type="text" placeholder="ID do vídeo no youtube ou vimeo" />
                    </label>

                    <label class="label">
                        <span class="legend icon-play">Cor Predominante:</span>
                        <input name="course_color" value="<?= $course_color; ?>" type="text" placeholder="#F4F4F4F" />
                    </label>
                </div>

                <label class="label">
                    <span class="legend icon-filter">Nível</span>
                    <select name="course_level" required>
                        <option value="" selected disabled>Selecione um nível</option>
                        <option value="Básico" <?= (!empty($course_level) && $course_level == 'Básico' ? "selected" : NULL); ?>>Básico</option>
                        <option value="Intermediário" <?= (!empty($course_level) && $course_level == 'Intermediário' ? "selected" : NULL); ?>>Intermediário</option>
                        <option value="Avançado" <?= (!empty($course_level) && $course_level == 'Avançado' ? "selected" : NULL); ?>>Avançado</option>
                    </select>
                </label>
                ...
                <div class="label_50">
                    ...
                    <label class="label">
                        ...
                        <input type="text" name="course_vendor_price" value="<?= $course_vendor_price ? number_format($course_vendor_price, '2', ',', '.') : "0,00"; ?>" placeholder="Preço do Curso:" required/>
                    </label>
                </div>
                ...
                <div class="wc_actions">
                    <label class="label_check label_publish <?= ($course_feature == 1 ? 'active' : ''); ?>"><input style="margin-top: -1px;" type="checkbox" value="1" name="course_feature" <?= ($course_feature == 1 ? 'checked' : ''); ?>> Destacar Curso!</label>
        ...
        <!--ADICIONADO ESTA FUNÇÃO QUE NÃO POSSUI NA VERÇÃO ORIGINAL-->
            ...
            <div class="panel wc_tab_target none" id="certification">
                ...
                <form name="course_certification" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="certification_cover" style="margin-bottom: 15px;">
                        ...
                        $CourseCertificationCover = (!empty($course_certification_cover) && file_exists("../uploads/{$course_certification_cover}") && !is_dir("../uploads/{$course_certification_cover}") ? "uploads/{$course_certification_cover}" : 'admin/_img/ead_certification_cover.png');
                        ?>
                        <div class="label_50">
                            <label class="label">
                                <img class="course_certification_mockup post_cover" alt="Certificado" title="Certificado" src="../<?= $CourseCertification; ?>" default="../<?= $CourseCertification; ?>"/>
                            </label>
                            <label class="label">
                                <img class="course_certification_cover post_cover" alt="Cover do Certificado" title="Cover do Certificado" src="../<?= $CourseCertificationCover; ?>" default="../<?= $CourseCertificationCover; ?>"/>
                            </label>
                        </div>
                            <div class="clear"></div>
                    </div>
                    ...
                    <div class="label_50">
                        <label class="label">
                            <span class="legend icon-image">Plano de Fundo (Mockup do Certificado):</span>
                            <input name="course_certification_mockup" class="wc_loadimage" value="" type="file">
                        </label>

                        <label class="label">
                            <span class="legend icon-image">Cover do Certificado:</span>
                            <input name="course_certification_cover" class="wc_loadimage" value="" type="file">
                        </label>
                    </div>
