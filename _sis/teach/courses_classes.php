    ...
    <div class="box box100" style="margin: 0; padding: 0;">
        <div class="box_content">
            <form name="class_add" action="" method="post" enctype="multipart/form-data">
                ...
                <label class="label">
                   <label class="label_check label_publish <?= (!empty($class_free) && $class_free == 1 ? 'active' : ''); ?>"><input style="margin-top: -1px;" type="checkbox" value="1" name="class_free" <?= (!empty($class_free) && $class_free == 1 ? 'checked' : ''); ?>> Aula Grátis!</label>
                </label>
