...
<div class="dashboard_content">
    ...
    <div class="box box25">
        <div class="panel_header success">
            ...
            <h2 class="icon-earth">ONLINE AGORA:
            </h2>
        </div>
        <div class="panel" style="text-align: center;">
            <?php
            $Read->FullRead("SELECT count(online_id) AS total from " . DB_VIEWS_ONLINE . " WHERE online_endview >= NOW()");
            echo "<p class='wc_ead_dashteach'><b class='wc_ead_dashteach_count wc_studentonline'>" . str_pad($Read->getResult()[0]['total'], 4, 0, STR_PAD_LEFT) . "</b></p>";
            ?>
            <a class="icon-target" style="color: #999;" href="dashboard.php?wc=onlinenow" title="Ver Usuários Online">ACOMPANHAR USUÁRIOS</a>
            <div class="clear"></div>
        </div>
    </div>
            ...
            <div class="panel">
                ...
                if (!$Read->getResult()):
                    ...
                    foreach ($Read->getResult() as $Comm):
                        ...
                        elseif ($Comm['class_id']):
                            $Read->FullRead("SELECT class_name, class_id, class_title FROM " . DB_CLASS . " WHERE class_id = :id", "id={$Comm['class_id']}");
                            $Link = BASE . "/campus/campus.php?wc=cursos/play&id={$Read->getResult()[0]['class_id']}";
                            $Title = $Read->getResult()[0]['class_title'];
                        endif;
    ...
    if (APP_SEARCH):
        ...
        <div class="box box100">
            <div class="panel_header custom_default">
