<div class="wc_ead">
    ...
    <header class="dashboard_header">
        <div class="dashboard_header_title">
            <h1 class="icon-lab">Todos os Cursos</h1>
            <p class="dashboard_header_breadcrumbs">
                ...
                <span class="crumb">/</span>
                <a style="font-weight:normal" title="Cursos em Destaque" href="campus.php?wc=cursos/destaques">Cursos em Destaque</a>
                <span class="crumb">/</span>
                <a title="Todos os Cursos" href="campus.php?wc=cursos/todos">Todos os Cursos</a>
            </p>
        </div>
    </header>
    ...
    <div class="box_wrap">
        ...
        $Pager = new Pager(BASE .'/campus/campus.php?wc=cursos/todos&campus=', '<<', '>>', 3);
