<article class='dash_view_activities_favorites_content_course dash_view_course'>
    <?php
    //VALID ENROLLMENT
    ...
    if (!$Read->getResult()):
        ...
        echo "<img class='brand' src='" . BASE . "/tim.php?src=uploads/{$course_cover}&w=300&h=100' alt='Conheça o Curso {$course_title}' title='Conheça o Curso {$course_title}'>";
        echo "<h1 class='title normalize_height_course'>{$course_title}</h1>";
