...
<head>
    ...
    <title>Ativar Matrícula - <?= SITE_NAME; ?>!</title>
    ...
    <meta itemprop="name" content="Ativar Matrícula - <?= SITE_NAME; ?>!"/>
    ...
    <meta property="og:title" content="Ativar Matrícula - <?= SITE_NAME; ?>!" />
    ...
    <meta property="twitter:title" content="Ativar Matrícula - <?= SITE_NAME; ?>!" />
    ...
    <div class="login_box">
        ...
        <div class="login_box_content radius">
            <form class="" name="work_login" action="" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="callback_action" value="wc_ead_register_course_free_add">
                ...
                <button class="login_btn">Ativar Minha Matrícula</button>
            </form>
        </div>
    </div>
</div>
