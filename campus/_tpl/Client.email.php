...
<table width="550" style="font-family: "Trebuchet MS", sans-serif;">
 <tr><td>
  ...
  <img src="' . BASE . '/beta/_img/mail.jpg" alt="Atenciosamente ' . SITE_NAME . '" title="Atenciosamente ' . SITE_NAME . '" /><br><br>
   ' . SITE_NAME . '<br>Telefone: ' . SITE_ADDR_PHONE . '<br>E-mail: ' . SITE_ADDR_EMAIL . '<br><br>
